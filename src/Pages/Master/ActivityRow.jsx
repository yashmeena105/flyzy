...
const ActivityRow = ({ data, importable = false, onImport, location }) => {
  ...
  const content = (
    <>
      <Modal
        ...
        footer={null}
      >
        <ActivityDetails actid={data.id} readonly={true} />
      </Modal>
      <Row
        wrap={false}
        style={{
                      ...
                      extra={
                        <Input.Group compact>
                          ...
                          <InputNumber
                            ...
                            defaultValue={0}
                            onChange={(e) => {
                              let newItemData = [...selectedPackages];
                              newItemData[j].quantity = e;
                              console.log("newItemData", newItemData);
                              setSelectedPackages(newItemData);
                            }}
                          />
                          {/* <Button size="small">+</Button> */}
                        </Input.Group>
                ...
                <Card size="small">
                  <Row justify="space-between">
                    ...
                    <Col>
                      <Text strong>
                        ₹
                        {selectedPackages.reduce(function (sum, item) {
